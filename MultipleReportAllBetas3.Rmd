...
all.betas <- list("strong.sel", "medium.sel", "weak.sel", "no.sel")
  ...
  exp.MSDi.quantile1 = matrix(ncol = ncol(m.exp.MSDi), nrow = 1)
  exp.MSDi.quantile2 = matrix(ncol = ncol(m.exp.MSDi), nrow = 1)

  for (i in (1:n.sites.p.ref)) {
      exp.smooth.norm.dr.squarei.quantiles = as.vector(quantile((m.exp.smooth.norm.dr.squarei[, i]), probs = c(0.05, 0.95), na.rm = T))
      exp.MSDi.quantile1[1, i] = exp.smooth.norm.dr.squarei.quantiles[1]
      exp.MSDi.quantile2[1, i] = exp.smooth.norm.dr.squarei.quantiles[2]
  }

  m.mean.exp.MSDi[as.vector(all.betas == beta), 1:n.sites.p.ref] = exp.smooth.norm.MSDi[1:n.sites.p.ref]
  m.exp.MSDi.quantile1[as.vector(all.betas == beta), 1:length(exp.MSDi.quantile1)] = exp.MSDi.quantile1
  m.exp.MSDi.quantile2[as.vector(all.betas == beta), 1:length(exp.MSDi.quantile2)] = exp.MSDi.quantile2
  ...
  for (i in (1:n.sites.p.ref)) {
    fit = lm(exp.smooth.norm.MSDi[1:n.sites.p.ref] ~ as.numeric(m.theo.smooth.norm.dr.squarei[i, 1:n.sites.p.ref]))
    MSDi.fit = fitted.values(fit)
    m.theo.smooth.norm.dr.squarei[i, 1:n.sites.p.ref] = MSDi.fit
  }
  ...
  mean.theo.MSDi.group = theo.MSDi.group$mean.mean.group[1:n.sites.p.ref]
  theo.MSDi.group.quantile1 = theo.MSDi.group$mean.quantile1.group[1:n.sites.p.ref]
  theo.MSDi.group.quantile2 = theo.MSDi.group$mean.quantile2.group[1:n.sites.p.ref]
  theo.MSDi.quantile1.mean = theo.MSDi.group$quantile1.mean[1:n.sites.p.ref]
  theo.MSDi.quantile2.mean = theo.MSDi.group$quantile2.mean[1:n.sites.p.ref]
...
plot(m.mean.theo.MSDi.group[1, ], 
     main = "MSDi strong selection", 
     xlab = "mode",
     ylab = "MSDi",
     ylim = c(0, max(c(m.theo.MSDi.group.quantile2, m.mean.exp.MSDi))))
...
plot(m.mean.theo.MSDi.group[2, ], 
     main = "MSDi medium selection", 
     xlab = "mode",
     ylab = "MSDi",
     ylim = c(0, max(c(m.theo.MSDi.group.quantile2[2,], m.mean.exp.MSDi[2,]))))
...
plot(m.mean.theo.MSDi.group[3, ], 
     main = "MSDi weak selection", 
     xlab = "mode",
     ylab = "MSDi",
     ylim = c(0, max(c(m.theo.MSDi.group.quantile2[3, ], m.mean.exp.MSDi[3, ]))))
...
plot(m.mean.theo.MSDi.group[4, ], 
     main = "MSDi no selection", 
     xlab = "mode",
     ylab = "MSDi",
     ylim = c(0, max(c(m.theo.MSDi.group.quantile2[4, ], m.mean.exp.MSDi[4, ]))))
...
plot(m.mean.theo.MSDi.group[1, ], 
     ...
     xlab = "mode",
     ylab = "MSDi",
     ylim = c(0, max(c(m.theo.MSDi.group.quantile2[1, ], m.mean.exp.MSDi[1, ]))))
