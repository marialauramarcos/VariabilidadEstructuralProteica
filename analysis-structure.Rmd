...
plot(x = log(p.accept.mut), y = score, xlab = "log(paccept no-selection)")
plot(x = score, y = CN) 
...
plot(x = d.exp$mean.z.RSD, y = CN, xlab = "<zRSDi> experimental ")
plot(x = d.mut$mean.z.RSD, y = CN, xlab = "<zRSDi> no-selection")
plot(x = d.medium$mean.z.RSD, y = CN, xlab = "<zRSDi> selection")
...
cor.df = data.frame("comparison" = c("<z.RSD> experimental vs CN", "<z.RSD> no-selection vs CN", "<z.RSD> selection vs CN"),
