...
In this section we consider dynamical divergence using normal modes coordinates.


```{r comparisson-of-means, fig.cap = "blue = experimental - green = mut - red = medium selection"}
# calculate means
...
```{r comparisson-of-means-100-modes}
