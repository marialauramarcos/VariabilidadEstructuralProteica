# Description:
# This function compares two proteins, "p.ref" and "p.2", in a multiple sequence alignment
#
# Usage:
# AnalyzeAlignment(alignment, pdbid, p.ref, p.2)
#
#  Args:
#   - alignment: multiple sequence alignment in FASTA format as obtained with ReadFasta()
