...
plot(rank(nsF.cF.theo.MSDi, na.last = "keep"), main = "MSDi ns = F, c = F", xlab = "site", ylab = "rank MSDi")
points(rank(cF.exp.MSDi, na.last = "keep"), col = "red")
plot(rank(nsT.cF.theo.MSDi, na.last = "keep"), main = "MSDi ns = T, c = F", xlab = "site", ylab = "rank MSDi")
points(rank(cF.exp.MSDi, na.last = "keep"), col = "red")
plot(rank(nsF.cT.theo.MSDi, na.last = "keep"), main = "MSDi ns = F, c = T", xlab = "site", ylab = "rank MSDi")
points(rank(cT.exp.MSDi, na.last = "keep"), col = "red")
plot(rank(nsT.cT.theo.MSDi, na.last = "keep"), main = "MSDi ns = T, c = T", xlab = "site", ylab = "rank MSDi")
points(rank(cT.exp.MSDi, na.last = "keep"), col = "red")
```
rojo: experimental
negro: teorico
...
## R^2 y MSE
Las comparaciones entre perfines promedio Pn y MSDi teoricos fiteados y experimentales se muestran a continuacion. En cada grafico se muestra la correlacion (R^2) y el error (MSE).
```{r}
layout(matrix(1:4, 2, 2, byrow = T)) 
