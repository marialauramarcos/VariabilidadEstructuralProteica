...
cor.df = data.frame("Comparison R0.1" = c("log(paccept no-selection) vs CN", "log(paccept no-selection) vs score", "score vs CN"),
...
cor.df = data.frame("Comparison R0.1" = c("log(paccept selection) vs CN", "log(paccept selection) vs score", "score vs CN"),
...
cor.df = data.frame("Comparison R0.2" = c("log(paccept no-selection) vs CN", "log(paccept no-selection) vs score", "score vs CN"),
                    "R" = c(r.p.accept.mut.CN , r.p.accept.mut.score, r.score.CN))
...
cor.df = data.frame("Comparison R0.2" = c("log(paccept selection) vs CN", "log(paccept selection) vs score", "score vs CN"),
                    "R" = c(r.p.accept.medium.sel.CN , r.p.accept.medium.sel.score, r.score.CN))
...
# save data
R0.1.mean.exp = d.exp$median.Pn
R0.1.mean.mut = d.mut$median.Pn
R0.1.mean.medium = d.medium$median.Pn
...
# save data
R0.2.mean.exp = d.exp$median.Pn
R0.2.mean.mut = d.mut$median.Pn
R0.2.mean.medium = d.medium$median.Pn
...
# save data
R0.1.mean.exp = d.exp$mean.nH
R0.1.mean.mut = d.mut$mean.nH
R0.1.mean.medium = d.medium$mean.nH
...
# save data
R0.2.mean.exp = d.exp$mean.nH
R0.2.mean.mut = d.mut$mean.nH
R0.2.mean.medium = d.medium$mean.nH
