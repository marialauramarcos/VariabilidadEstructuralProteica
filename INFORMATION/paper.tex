...
\begin{equation}
d\mathbf{r}^{0,tot} = d\mathbf{r}^{0,mut1}_{wt}+d\mathbf{r}^{0,mut2}_{wt}+ ...+d\mathbf{r}^{0,mutm}_{wt}+...+d\mathbf{r}^{0,mutNmut}_{wt}
\end{equation}

\begin{equation}
d\mathbf{r}^{0,tot} =\mathbf{K}^{-1}_{wt}\times(\mathbf{f}_{mut1}+\mathbf{f}_{mut2}+...+\mathbf{f}_{mutm}+...+\mathbf{f}_{mutNmut}) 
\end{equation}

Where $d\mathbf{r}^{0,tot}$ is the total structural variation due the M mutations, $d\mathbf{r}^{0,mutm}_{wt}$ is the structural variation produced by the mutation $m$ (considering $\mathbf{K}_{wt}$), and $\mathbf{f}_mutm}$ is the vector of force of the $m$ mutation.
