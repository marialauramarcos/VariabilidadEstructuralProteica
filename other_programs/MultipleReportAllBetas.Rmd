...
all.betas <- list("strong.sel", "medium.sel", "weak.sel", "no.sel")
  ...
  for (beta in all.betas)  {
    ...
    exp.smooth.norm.MSDi = (exp.smooth.norm.MSDi - mean(sqrt(exp.smooth.norm.MSDi)))/sd(sqrt(exp.smooth.norm.MSDi)) 
    ...
    theo.smooth.norm.MSDi = (theo.smooth.norm.MSDi - mean(sqrt(theo.smooth.norm.MSDi)))/sd(sqrt(theo.smooth.norm.MSDi)) 
