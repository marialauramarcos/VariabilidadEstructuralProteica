...
plot(y = d.exp$mean.z.RSD - d.mut$mean.z.RSD, x = m.min.da.CM.CA$min.da.CA[indexes.core], xlab = "minimal distance to active site (between CAs)", ylab = "exp.mean.z.RSD - mut.mean.z.RSD")
plot(y = d.exp$mean.z.RSD - d.mut$mean.z.RSD, x = m.min.da.CM.CA$min.da.CM[indexes.core], xlab = "minimal distance to active site (between CMs)", ylab = "exp.mean.z.RSD - mut.mean.z.RSD")

## calculate correlations between profiles
r.min.da.CA = cor((d.exp$mean.z.RSD - d.mut$mean.z.RSD), m.min.da.CM.CA$min.da.CA[indexes.core])
r.min.da.CM = cor((d.exp$mean.z.RSD - d.mut$mean.z.RSD), m.min.da.CM.CA$min.da.CM[indexes.core])
...
plot(y = d.exp$mean.z.RSD - d.mut$mean.z.RSD, x = m.sum.inv.da.CM.CA$sum.inv.da.CA[indexes.core], xlab = "sum.inv distance to active site (between CAs)", ylab = "exp.mean.z.RSD - mut.mean.z.RSD")
plot(y = d.exp$mean.z.RSD - d.mut$mean.z.RSD, x = m.sum.inv.da.CM.CA$sum.inv.da.CM[indexes.core], xlab = "sum.inv distance to active site (between CMs)", ylab = "exp.mean.z.RSD - mut.mean.z.RSD")

## calculate correlations between profiles
r.sum.inv.da.CA = cor((d.exp$mean.z.RSD - d.mut$mean.z.RSD), m.sum.inv.da.CM.CA$sum.inv.da.CA[indexes.core])
r.sum.inv.da.CM = cor((d.exp$mean.z.RSD - d.mut$mean.z.RSD), m.sum.inv.da.CM.CA$sum.inv.da.CM[indexes.core])
...
## calculate correlations between profiles
r.min.da.CA.CN = cor(CN, m.min.da.CM.CA$min.da.CA[indexes.core])
r.min.da.CM.CN = cor(CN, m.min.da.CM.CA$min.da.CM[indexes.core])
...
## calculate correlations between profiles
r.sum.inv.da.CA.CN = cor(CN, m.sum.inv.da.CM.CA$sum.inv.da.CA[indexes.core])
r.sum.inv.da.CM.CN = cor(CN, m.sum.inv.da.CM.CA$sum.inv.da.CM[indexes.core])
...
### Sequence comparison
In this section we compare theoretical sequence profiles with sequence scores obtained from ConsurfDB. To obtain theoretical profiles, we calculated the number of times we had mutated each site for each selection regimen. 
...
mean.p.accept.no.sel = mean.p.accept.no.sel[indexes.core]
mean.p.accept.strong.sel = mean.p.accept.strong.sel[indexes.core]
