...
p.facet %+% subset(dat, dataset == "medium")
p.facet
```
...
#dat$dataset = revalue(dat$dataset,c("medium" = "mut+sel"))
dat = modeComparison.all.datasets
dat$dataset = revalue(dat$dataset, c("medium" = "selection"))
dat$dataset = revalue(dat$dataset, c("mut" = "no-selection"))
...
plot(x = dat.exp$Pn.median, 
     ...
     xlab = "exp.Pn.median", 
     ylab = "medium.Pn.median", 
     xlim = c(min(c(dat.exp$Pn.median, dat.medium$Pn.median)), max(c(dat.exp$Pn.median, dat.medium$Pn.median))),
     ylim = c(min(c(dat.exp$Pn.median, dat.medium$Pn.median)), max(c(dat.exp$Pn.median, dat.medium$Pn.median))))
abline(0, 1)
...
plot(x = dat.mut$Pn.median, 
     ...
     xlab = "mut.Pn.median", 
     ylab = "medium.Pn.median", 
     xlim = c(min(c(dat.mut$Pn.median, dat.medium$Pn.median)), max(c(dat.mut$Pn.median, dat.medium$Pn.median))),
     ylim = c(min(c(dat.mut$Pn.median, dat.medium$Pn.median)), max(c(dat.mut$Pn.median, dat.medium$Pn.median))))
abline(0, 1)
```
