...
We use the ```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE)
``` Elastic Network Model with `R0 =` `r R0` for the `r family` family. 
...
plot(y = z.RSD.exp-z.RSD.strong, x = m.min.da.CM$min.da.ca)
plot(y = (z.RSD.exp-z.RSD.mut), x = m.min.da.CM$min.da.CM)
