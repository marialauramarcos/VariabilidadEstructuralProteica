...
m.min.da.CM = read.csv(file.path(data.dir, "min.da.CM.csv", sep = ""))$x[1:151]

z.RSD.exp = d$mean.z.RSD[d$dataset == "exp"]
z.RSD.strong = d$mean.z.RSD[d$dataset == "strong"]
z.RSD.mut = d$mean.z.RSD[d$dataset == "mut"]

plot(y = z.RSD.exp-z.RSD.strong, x = m.min.da.CM)
abline(0,0, col = "red")
plot(y = (z.RSD.exp-z.RSD.mut), x = m.min.da.CM)
abline(0,0, col = "red")
