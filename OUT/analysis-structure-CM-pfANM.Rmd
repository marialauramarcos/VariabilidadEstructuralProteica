...
source("out_subset_CM_pfANM/multiplot.R")
source("out_subset_CM_pfANM/my-functions.R")
```
...
f99 = 2.6
f999 = 3.3
data.dir = paste("out_subset_CM_pfANM", sep = "")
```
...
dri2.exp.fname = file.path(data.dir, paste(family, "_R0_NC_beta_no.sel_K.analysis_Keff_out_m.exp.norm.dr.squarei.csv", sep = ""))
Pn.exp.fname = file.path(data.dir, paste(family,"_R0_NC_beta_no.sel_K.analysis_Keff_out_m.exp.Pn.csv", sep = ""))
energy.exp.fname = file.path(data.dir, paste(family, "_R0_NC_beta_no.sel_K.analysis_Keff_out_m.exp.va.csv", sep = ""))

dri2.strong.fname = file.path(data.dir, paste(family, "_R0_NC_beta_strong.sel_K.analysis_Keff_out_m.theo.norm.dr.squarei.csv", sep = ""))
Pn.strong.fname = file.path(data.dir, paste(family, "_R0_NC_beta_strong.sel_K.analysis_Keff_out_m.theo.Pn.csv", sep = ""))
energy.strong.fname = file.path(data.dir, paste(family, "_R0_NC_beta_strong.sel_K.analysis_Keff_out_m.theo.va.csv", sep = ""))

dri2.mut.fname = file.path(data.dir,paste(family, "_R0_NC_beta_no.sel_K.analysis_Keff_out_m.theo.norm.dr.squarei.csv", sep = ""))
Pn.mut.fname = file.path(data.dir, paste(family, "_R0_NC_beta_no.sel_K.analysis_Keff_out_m.theo.Pn.csv", sep = ""))
energy.mut.fname = file.path(data.dir, paste(family, "_R0_NC_beta_no.sel_K.analysis_Keff_out_m.theo.va.csv", sep = ""))
